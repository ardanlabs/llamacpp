...
func Routes(app *web.App, cfg Config) {
	...
	app.HandlerFunc(http.MethodGet, version, "/mngt/model/pull", api.pull, bearer)
	app.HandlerFunc(http.MethodGet, version, "/mngt/model/remove", api.remove, bearer)
	app.HandlerFunc(http.MethodGet, version, "/mngt/model/show", api.show, bearer)
}
